...
- Follow-up finding F21 was resolved on 2026-07-22 without moving or renumbering the detailed friction material. The section 3.7 introduction now gives readers a main-route link directly to the generic friction equations in section 3.7.3, while sections 3.7.1-3.7.2 are labelled optional detail. Section 5 still repeats and substitutes the adopted linear models. Preserve the `frictionEquations` fragment and this skip guidance if the friction section is edited.
- Follow-up finding F22 was resolved on 2026-07-22 by consistently identifying equation (12) as the horizontal balance for the combined cart-pole system. Preserve that system boundary in the section 3.4 heading and later references: it explains both the pole inertial term and the cancellation of the internal pivot interaction.
- Follow-up finding F23 was resolved on 2026-07-22 with a compact definition of the standard sign function immediately after equation (21). The explanation states how the leading minus sign makes cart friction oppose velocity and distinguishes the resulting zero friction at exactly zero velocity from unmodelled static friction. Preserve this qualification and apply the same definition to later pivot-friction uses of $\sgn(\dot\theta)$.
