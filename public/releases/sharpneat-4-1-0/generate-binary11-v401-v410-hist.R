...
dat1 <- read.table("binary11-samples-v4_0_1.csv", sep=",", head=TRUE)
dat2 <- read.table("binary11-samples-v4_1_0.csv", sep=",", head=TRUE)
...
createAndSavePlot(dat, 'bestfitness', cbPalette, "binary11-bestfitness-v401-v410-hist.png", 'fitness')
createAndSavePlot(dat, 'evalcount', cbPaletteB, "binary11-evalcount-v401-v410-hist.png", 'evaluation count')
createAndSavePlot(dat, 'meancomplexity', cbPaletteC, "binary11-meancomplexity-v401-v410-hist.png", 'mean complexity')
