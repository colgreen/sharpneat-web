...
dat1 <- read.table("sinewave-samples-v2-3-1.csv", sep=",", head=TRUE)
dat2 <- read.table("sinewave-samples-v2-4-0.csv", sep=",", head=TRUE)
...
ggsave(filename="sinewave-bestfitness-v231-v240-hist.png", plot=p4, height=4, width=8, units="in", dpi=100)
...
ggsave(filename="sinewave-evalcount-v231-v240-hist.png", plot=p2, height=4, width=8, units="in", dpi=100)
