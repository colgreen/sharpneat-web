...
dat1 <- read.table("binary11-samples-v2-4-2-mon.csv", sep=",", head=TRUE)
dat2 <- read.table("binary11-samples-v2-4-3.csv", sep=",", head=TRUE)
...
ggsave(filename="binary11-bestfitness-v242-v243-hist.png", plot=p1, height=4, width=8, units="in", dpi=100)
...
ggsave(filename="binary11-evalcount-v242-v243-hist.png", plot=p2, height=4, width=8, units="in", dpi=100)
...
ggsave(filename="binary11-meancomplexity-v242-v243-hist.png", plot=p2, height=4, width=8, units="in", dpi=100)
