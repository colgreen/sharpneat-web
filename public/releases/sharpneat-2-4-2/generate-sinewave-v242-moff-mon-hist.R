...
dat1 <- read.table("sinewave-samples-v2-4-2-moff.csv", sep=",", head=TRUE)
dat2 <- read.table("sinewave-samples-v2-4-2-mon.csv", sep=",", head=TRUE)
...
ggsave(filename="sinewave-bestfitness-v242moff-v242mon-hist.png", plot=p4, height=4, width=8, units="in", dpi=100)
...
ggsave(filename="sinewave-evalcount-v242moff-v242mon-hist.png", plot=p2, height=4, width=8, units="in", dpi=100)
