...
dat1 <- read.table("binary11-samples-v2-4-1.csv", sep=",", head=TRUE)
dat2 <- read.table("binary11-samples-v2-4-2-moff.csv", sep=",", head=TRUE)
...
ggsave(filename="binary11-bestfitness-v241-v242moff-hist.png", plot=p1, height=4, width=8, units="in", dpi=100)
...
ggsave(filename="binary11-evalcount-v241-v242moff-hist.png", plot=p2, height=4, width=8, units="in", dpi=100)
